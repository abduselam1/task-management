    ...
    @if (count($tasks) != 0)
        ...
        <div wire:sortable="updateTaskOrder" >
            @foreach ($tasks as $task)
                <li wire:sortable.item="{{ $task->id }}" wire:key="task-{{ $task->id }}" class=" flex w-full justify-between cursor-move py-3 text-left">
                    ...
                    <div class="px-3 py-1 w-full border-b flex" >
